...
const sobre1 = new Cl_Sobre(1, 5, 10);
const sobre2 = new Cl_Sobre(2, 2, 20);
const sobre3 = new Cl_Sobre(3, 4, 100);
const sobre4 = new Cl_Sobre(4, 3, 50);
const procesarS = new Cl_ProcesarSobre();
